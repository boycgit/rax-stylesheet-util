...
var _urix_0_1_0_urix = urix;

var _atob_1_1_3_atob = createCommonjsModule(function (module) {
(function () {
...
function resolveSourceMapHelper(code, codeUrl) {
  codeUrl = _urix_0_1_0_urix(codeUrl);
  ...
  if (dataUri) {
    ...
    return {
      ...
      map: parseMapToJSON(lastParameter === ";base64" ? _atob_1_1_3_atob(encoded) : decodeURIComponent(encoded))
    }
  }
...
function resolveSourcesHelper(map, mapUrl, options, fn) {
  options = options || {};
  mapUrl = _urix_0_1_0_urix(mapUrl);
  var fullUrl;
  var sourceContent;
  for (var index = 0, len = map.sources.length; index < len; index++) {
    if (map.sourceRoot && !options.ignoreSourceRoot) {
      ...
      // does not make sense.
      fullUrl = resolveUrl_1(mapUrl, map.sourceRoot.replace(endingSlash, "/"), map.sources[index]);
    } else {
...
exports.emit = function(str, pos) {
  if (pos) {
    var sourceFile = _urix_0_1_0_urix(pos.source || 'source.css');
...
exports.applySourceMaps = function() {
  Object.keys(this.files).forEach(function(file) {
    ...
    if (this.options.inputSourcemaps !== false) {
      var originalMap = sourceMapResolveNode.resolveSync(
        content, file, fs.readFileSync);
      if (originalMap) {
        var map = new SourceMapConsumer(originalMap.map);
        var relativeTo = originalMap.sourcesRelativeTo;
        this.map.applySourceMap(map, file, _urix_0_1_0_urix(path.dirname(relativeTo)));
      }
    }
  }, this);
};
...
var _supportsColor_5_3_0_supportsColor = {
...
try {
  var supportsColor = _supportsColor_5_3_0_supportsColor;
...
var name = "rax-stylesheet-util";
var version = "0.0.1";
var description = "rax stylesheet utils";
var main = "dist/index.js";
var module$1 = "dist/index.es.js";
var scripts = {"dev":"./node_modules/.bin/rollup -c --watch","build":"NODE_ENV=production ./node_modules/.bin/rollup -c","size":"size-limit","test":"jest && eslint ."};
var repository = {"type":"git","url":"git+https://github.com/boycgit/rax-stylesheet-util.git"};
var keywords = ["rax","stylesheet","util"];
var author = "boycgit";
var license = "MIT";
var bugs = {"url":"https://github.com/boycgit/rax-stylesheet-util/issues"};
var homepage = "https://github.com/boycgit/rax-stylesheet-util#readme";
var devDependencies = {"babel-core":"^6.26.0","babel-jest":"^22.4.3","babel-plugin-external-helpers":"^6.22.0","babel-preset-env":"^1.6.1","babel-preset-es2015-rollup":"^3.0.0","eslint":"^4.19.1","jest":"^22.4.3","rollup":"^0.57.1","rollup-plugin-babel":"^3.0.3","rollup-plugin-commonjs":"^9.1.0","rollup-plugin-eslint":"^4.0.0","rollup-plugin-json":"^2.3.0","rollup-plugin-node-builtins":"^2.1.2","rollup-plugin-node-globals":"^1.2.0","rollup-plugin-node-resolve":"^3.3.0","rollup-plugin-replace":"^2.0.0","rollup-plugin-uglify":"^3.0.0","size-limit":"^0.17.0"};
var dependencies = {"camelcase":"^5.0.0","chalk":"^2.3.2","css":"^2.2.1","debug":"^3.1.0"};
var pkg = {
	name: name,
	version: version,
	...
	"size-limit": [{"path":"build/index.js"}]
};

// const result = fs.readFileSync('./package.json');
console.log(777, pkg);
var ast = parse$1('body { font-size: 12px; }');
